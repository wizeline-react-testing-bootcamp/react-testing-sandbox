...
app
  ...
  .then(() => {
    ...
    server.get(
      "/r/:subredditName/comments/:postId/:safeTitleURL?",
      (req, res) => {
        const actualPage = "/";
        const queryParams = {
          ...req.query,
    ...
    server.get(
      "/r/:subredditName/:sort(best|hot|new|rising|controversial|top|gilded|all|popular|random)?",
      (req, res) => {
        const actualPage = "/";
        const queryParams = {
          ...req.query,
    ...
    server.get(
      "/:sort(best|hot|new|rising|controversial|top|gilded|all|popular|random)?",
      (req, res) => {
        const actualPage = "/";
        const queryParams = {
          ...req.query,
