...
export const SelectBox = styled.select`
  ...
  font-size: 14px;
  background: url(https://cdn3.iconfinder.com/data/icons/google-material-design-icons/48/ic_arrow_drop_down_48px-512.png)
    no-repeat calc(100% - 3px);
...
export const SelectBox2 = styled.select`
  ...
  background-position: calc(100% - 7px) calc(1em - 2px),
    calc(100% - 2px) calc(1em - 2px), calc(100% - 2.5em) 0.5em;
